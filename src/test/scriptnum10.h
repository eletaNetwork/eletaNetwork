...
#ifndef ELETACOIN_TEST_SCRIPTNUM10_H
#define ELETACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from EletaCoin Core 0.10.0, for cross-comparison.
 */
public:
