...
#define BOOST_TEST_MODULE EletaCoin Test Suite

#include "test_eletacoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_eletacoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
