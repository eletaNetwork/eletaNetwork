 ...
 */
#ifndef ELETACOIN_UTIL_H
#define ELETACOIN_UTIL_H
...
extern const char * const ELETACOIN_CONF_FILENAME;
extern const char * const ELETACOIN_PID_FILENAME;
...
{
    std::string s = strprintf("eletacoin-%s", name);
