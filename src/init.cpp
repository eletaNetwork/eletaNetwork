...
// Copyright (c) 2017 The EletaCoin developers
 ...
 * between eletacoind, and eletacoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("eletacoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), ELETACOIN_CONF_FILENAME));
    if (mode == HMM_ELETACOIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), ELETACOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/eletacoindev/eletacoin-core>";
    const std::string URL_WEBSITE = "<https://eletacoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("eletacoin-loadblk");
    CImportingNow imp;
...
/** Sanity checks
 *  Ensure that EletaCoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("EletaCoin version %s\n", FormatFullVersion());
}

/** Initialize eletacoin.
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single EletaCoin process is using the data directory.
    ...
    if(GetBoolArg("-staking", true))
        threadGroup.create_thread(boost::bind(&EletaCoinStaker, boost::cref(chainparams)));
#endif
