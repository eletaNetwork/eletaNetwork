...
#ifndef ELETACOIN_QT_WALLETFRAME_H
#define ELETACOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, EletaCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // ELETACOIN_QT_WALLETFRAME_H
