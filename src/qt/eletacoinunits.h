...
#ifndef ELETACOIN_QT_ELETACOINUNITS_H
#define ELETACOIN_QT_ELETACOINUNITS_H
...
/** EletaCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EletaCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EletaCoinUnits(QObject *parent);

    /** EletaCoin units.
      @note Source: https://en.eletacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ELT,
...
typedef EletaCoinUnits::Unit EletaCoinUnit;

#endif // ELETACOIN_QT_ELETACOINUNITS_H
