    ...
    mapper(0)
{
    ...
    ui->eletacoinAtStartup->setToolTip(ui->eletacoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->eletacoinAtStartup->setText(ui->eletacoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://chainz.cryptoid.info/eleta/tx.dws?%s.htm");
#endif

    ui->unit->setModel(new EletaCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->eletacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEletaCoinConfButton_clicked()
{
