...
#ifndef ELETACOIN_QT_SENDCOINSDIALOG_H
#define ELETACOIN_QT_SENDCOINSDIALOG_H
...
public Q_SLOTS:
    ...
    void checkEletatechServers();
    void showEltTechDialog();
...
#endif // ELETACOIN_QT_SENDCOINSDIALOG_H
