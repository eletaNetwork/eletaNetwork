...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(EletaCoinUnits::ELT),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = EletaCoinUnits::formatWithUnit(unit, amount, true, EletaCoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(EletaCoinUnits::formatWithUnit(unit, balance, false, EletaCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(EletaCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, EletaCoinUnits::separatorAlways));
    ui->labelStaking->setText(EletaCoinUnits::formatWithUnit(unit, stakingBalance, false, EletaCoinUnits::separatorAlways));
    ui->labelImmature->setText(EletaCoinUnits::formatWithUnit(unit, immatureBalance, false, EletaCoinUnits::separatorAlways));
    ui->labelTotal->setText(EletaCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, EletaCoinUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(EletaCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, EletaCoinUnits::separatorAlways));
    ui->label7dStakingStats->setText(EletaCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, EletaCoinUnits::separatorAlways));
    ui->label30dStakingStats->setText(EletaCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, EletaCoinUnits::separatorAlways));
