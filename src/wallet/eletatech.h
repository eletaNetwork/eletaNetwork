...
#ifndef ELETACOIN_WALLET_ELETATECH_H
#define ELETACOIN_WALLET_ELETATECH_H
...
#define ELETATECH_DEFAULT_INPUT_DELAY 1
#define ELETATECH_DEFAULT_OUT_DELAY 10
#define ELETATECH_DEFAULT_ENTROPY 4
...
struct eletatechData {
    std::string serverEltAddress;
...
#endif //ELETACOIN_WALLET_ELETATECH_H
