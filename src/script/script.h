...
#ifndef ELETACOIN_SCRIPT_SCRIPT_H
#define ELETACOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, EletaCoin always counted CHECKMULTISIGs
...
#endif // ELETACOIN_SCRIPT_SCRIPT_H
