...
class RawTransactionsTest(EletaCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid eletacoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid eletacoin address" in e.error['message'])
