...
unlocked to sign the EletaCoin-Qt.app bundle.
...
allowing somebody to distribute a EletaCoin-Qt.app or eletacoin-qt-setup.exe with a valid
...
that the eletacoin-qt.exe file inside the installer had not been tampered with.
