...
This document provides guidelines for internationalization of the EletaCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eletacoin_en.ts` remains unchanged.
